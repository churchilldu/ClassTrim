...
public enum DatasetEnum {
    ...
    ANT_7 ("ant-1_7",  Config.ROOT + "ant-1.7.0/org/", new Threshold(8, 7, 32)),
    ...
    // Todo reflection
    CAMEL_4 ("camel-1_4",  Config.ROOT + "apache-camel-1.4/camel-bundle-1.4.0/", new Threshold(7, 7, 20)),
    CAMEL_6 ("camel-1_6",  Config.ROOT + "apache-camel-1.6/org/", new Threshold(2, 7, 17)),

    LUCENE_0 ("lucene-2_0",  Config.ROOT + "apache-lucene-2.0/org/", new Threshold(8, 5, 15)),
    LUCENE_2 ("lucene-2_2",  Config.ROOT + "apache-lucene-2.2/org/", new Threshold(6, 6, 17)),
    LUCENE_4 ("lucene-2_4",  Config.ROOT + "apache-lucene-2.4/org/", new Threshold(5, 5, 15)),

    SYNAPSE_0 ("synapse-1_0",  Config.ROOT + "apache-synapse-1.0/org/", new Threshold(6, 12, 35)),
    SYNAPSE_1 ("synapse-1_1",  Config.ROOT + "apache-synapse-1.1/org/", new Threshold(7, 11, 31)),
    SYNAPSE_2 ("synapse-1_2",  Config.ROOT + "apache-synapse-1.2/org/", new Threshold(5, 10, 29)),
